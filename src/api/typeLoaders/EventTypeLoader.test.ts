...
import api from '..';
import type { KankaApiEvent, KankaApiEntity, KankaApiEntityId, KankaApiId, KankaApiModuleType } from '../../types/kanka';
...
describe('EventTypeLoader', () => {
    ...
    describe('createReferenceCollection()', () => {
        ...
        it('includes parents from the lookup array', async () => {
            ...
            const entities = [createEntity(1001, 2001, 'location'), createEntity(1002, 2002, 'event'), createEntity(1003, 2003, 'quest')];
