 ...
 * next-tier strictness flags layered on top of the main tsconfig.
 *
 * RATCHET — per-code error counts may only DECREASE.
 * STRICT — once a code's count reaches 0 it auto-graduates; future occurrences
 * are a hard fail with no --update escape.
 *
